    ...
    .then(function (response) {
      ...
      for (var a = 0; a < response.data.length; a++) {
        ...
        for (var i = 0; i < response.data[a].languages.length; i++) {
          ...
          $(langBoxClass).append(
            "<div style='max-width: 300px; width:100px; margin-bottom:4px;float: left;'>" +
              "<div class='circle'>" +
              "<div class='text' style='display: inline-block;'>" +
              response.data[a].languages[i].lan_nm +
              "</div>" +
              "</div>" +
              "</div>"
          );
        ...
        if (a + 1 == response.data.length) {
          $(".reposity .reposityBox").append(
            "<div class='col-5 profileBox'>" +
              ...
              "<a href='/Project'>" +
              "<svg aria-hidden='true'style='height:110px;' focusable='false' data-prefix='fas' data-icon='plus' class='svg-inline--fa fa-plus fa-w-14 ' role='img' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 448 512'>" +
                ...
                <div className="d-flex flex-column align-items-center text-center">
                  ...
                  <div className="mt-3">
                    ...
                    <p className="text-muted font-size-sm">
                      {props.userInfo.mbr_addr} {props.userInfo.mbr_cont}
                    </p>
                  </div>
                </div>
                <hr></hr>
